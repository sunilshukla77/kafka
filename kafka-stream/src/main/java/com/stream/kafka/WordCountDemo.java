...
public class WordCountDemo {
	...
	public static void main(String[] args) {
		...
		stream.filter((key, value)->value.contains("token"))//<Filter and map>
			  //.mapValues(value-> value.toUpperCase()) //Transform
			  .map((key, value)-> new KeyValue<>(key, value.toUpperCase()))  //Transform another way
			  .to("streams-dataflow-output"); //Send ot output topic
